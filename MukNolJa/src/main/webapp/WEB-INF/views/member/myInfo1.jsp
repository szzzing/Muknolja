	  	...
	  	<div class="row justify-content-center" >
            ...
            <br><br><br>
          			...
          			<div style="width:800px; height:100%; display:inLine-block; background: white"><div >
          				<div style=" margin-top:5vh; font-size: 50px; color:#6BB6EC; width: 800; display:flex; margin-left:280px;  text-align:center">${ loginUser.name }님 &nbsp;<div style="margin-top:20px;font-size:30px;">${ loginUser.id }</div></div></div>
            				<div style="float:left; margin-left: 150px; margin-top: 4vh;">
		            			<form action="${ contextPath }/change.me?id=${ loginUser.id }" method="POST">
