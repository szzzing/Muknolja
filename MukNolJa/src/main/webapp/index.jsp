<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%> <!-- Ï∂îÍ??†Î?Î∂? -->
...
<c:set var="contextPath" value="${ pageContext.request.contextPath }" scope="application"/>	
	   ...
	   <a id="a1" href="${ contextPath }/home.do"><div class="st" style="position:absolute; margin-top:3vh; margin-left: 18vw;">Í≤? Gyeong<br>Í∏? ggi</div></a>
	   <a href=""><div class="st" style=" position:absolute; margin-top:21vh; margin-left: 15vw;">?? Seo<br>?? Ul</div></a>
	   <a href=""><div class="st" style=" position:absolute; margin-top:8vh; margin-left: 47vw;">Í∞? Kang<br>?? Won</div></a>
	   <a href=""><div class="st" style=" position:absolute; margin-top:26vh; margin-left: 51vw;">Ï∂? Chung<br>Î∂? Buk</div></a>
	   <a href=""><div class="st" style=" position:absolute; margin-top:47vh; margin-left: 52vw;">Í≤? Gyeong<br>Î∂? Buk</div></a>
	   <a href=""><div class="st" style=" position:absolute; margin-top:73vh; margin-left: 47vw;">Í≤? Gyeong<br>?? Nam</div></a>
	   ...
	   <a href=""><div class="st" style=" position:absolute; margin-top:58vh; margin-left: 13vw;">?? Jeon<br>Î∂? Buk</div></a>
   ...
   <div class="time">?ÑÏû¨ ?úÍ∞Ñ</div>
   <div class="ctemp">?ÑÏû¨ ?®ÎèÑ</div>
   <div class="lowtemp">ÏµúÏ? ?®ÎèÑ</div>
   <div class="hightemp">ÏµúÍ≥† ?®ÎèÑ</div>
   <div class="icon"></div>
