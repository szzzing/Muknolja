...
public class PartyController {
	...
	public String deleteParty(@RequestParam("partyId") int partyId, @RequestParam("fileId") int fileId, @RequestParam(value="managerCheck", required=false) Integer check) {
